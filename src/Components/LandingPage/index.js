            ...
            <div className="FormSide FormText column">
              <div className="main">
                  <div className="InputField">
                      <label for="name"><i className="fa-solid fa-user IconBasics"></i></label>
                      <input type="text" className="InputBasics" name="Name" id="name" placeholder="Name" onChange={(e)=>{setName(e.target.value)}} required />
                  </div>
                  <br/>
                  <div className="InputField">
                      <label for="birthdate"><i className="fa-solid fa-calendar-days IconBasics"></i></label>
                  ...
                  <br/>
                  <div className="InputField">
                      <label for="Gender"><i className="fa-solid fa-person-half-dress IconBasics"></i></label>
                  ...
                  <br/>
                  <div className="InputField">
                      <label for="email"><i className="fa-solid fa-at IconBasics"></i></label>
                      <input type="email" className="InputBasics" name="email" id="email" placeholder="Email" onChange={(e)=>{setEmail(e.target.value)}} required />
                  </div>
                  <br/>
                  <div className="InputField">
                      <label for="phone"><i className="fa-solid fa-phone IconBasics"></i></label>
                  ...
                  <br/>
                  <div className="InputField">
                      <label for="Address"><i className="fa-solid fa-location-dot IconBasics"></i></label>
                  ...
                  <br/>
                  <div className="InputField">
                      <label for="Education"><i className="fa-solid fa-user-graduate IconBasics"></i></label>
                  ...
                  <br/>
                  <div className="InputField">
                      <label for="Skills"><i className="fa-solid fa-bolt IconBasics"></i></label>
                  ...
                  <br/>
                  <div className="InputField">
                      <label for="Certifications"><i className="fa-solid fa-award IconBasics"></i></label>
